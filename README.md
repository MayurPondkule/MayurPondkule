...
[![My Skills](https://skillicons.dev/icons?i=aws,Azure,docker,kubernetes,terraform,ansible,jenkins,githubactions,prometheus,grafana,linux,bash,git,python)](https://skillicons.dev)
